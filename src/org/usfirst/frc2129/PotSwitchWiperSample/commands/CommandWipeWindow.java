...
public class CommandWipeWindow extends Command {
    ...
    {
    	if (!Robot.wiper.getLeftLimitSwitchStatus())
    	{
    ...
    private WipeDirection CheckDirection( WipeDirection currentDirection)
    {
    	...
    	else if (!Robot.wiper.getRightLimitSwitchStatus())
    	{
    		return WipeDirection.left;
    	}
    	else
    ...
    protected void execute() {
    	...
    	if (direction == WipeDirection.left)
    	{
    		Robot.wiper.swipeLeft(Robot.motorSpeed);
    	}
    	else
    	{
    		Robot.wiper.swipeRight(Robot.motorSpeed);
    	}
    }
